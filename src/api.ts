 ...
 */
export async function fetchSpeciesNamesOfCharacter(
  character: Character
): Promise<string[]> {
  return Promise.all(
 ...
 */
export async function fetchFilmTitlesOfCharacter(
  character: Character
): Promise<string[]> {
  return Promise.all(
 ...
 */
export async function fetchSpecificSpecies(
  speciesId: string
): Promise<Species> {
  const res: Response = await fetch(
 ...
 */
export async function fetchCharactersOfSpecies(
  species: Species
): Promise<Character[]> {
  return Promise.all(
...
export async function fetchCharacters(
  ...
  const charactersResult: Response = await fetch(
    `https://swapi.dev/api/people/?search=${searchExpr}`
  );
